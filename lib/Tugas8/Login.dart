...
import 'package:ppkd_percobaan_1/Tugas8/home.dart';
      ...
      body: Stack(
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(color: colorBlueDark2AS),
          ),
          //Background putih
          Container(
            height: 561,
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      Image.asset("assets/images/Logisim.png", height: 34.0),
                      const Text(
                        "Login",
                        style: TextStyle(
                  ...
                  const Text(
                    "Enter your email and password to log in (Opsional)",
                    style: TextStyle(
                  ...
                  CustomTextField(hintText: "Masukkan Email"),
                  CustomTextField(
                    hintText: "*******",
                    isVisibility: false,
                    click: () {

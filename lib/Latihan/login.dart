...
class CobaSharedPreferences extends StatefulWidget {
  const CobaSharedPreferences({super.key});
  static const id = "/login_screen18";
  @override
  State<CobaSharedPreferences> createState() => _Tugas10State();
}

class _Tugas10State extends State<CobaSharedPreferences> {
